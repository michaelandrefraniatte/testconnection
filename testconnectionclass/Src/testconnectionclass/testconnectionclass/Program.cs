...
namespace testconnectionclass
{
    static class Program
    {
        ...
        private static string username, hash, uniqueid, userchecksumuniqueid;
        ...
        private static void createAuthRules()
        {
            try
            {
        ...
        private async static Task authConnection()
        {
            try
            {
                ...
                if (hash != hashedPass)
                {
                    MessageBox.Show("hash != hashedPass");
                    authconnecting = false;
                }
                actualuniqueid = getUniqueId();
                if (actualuniqueid == null)
                {
                    MessageBox.Show("actualuniqueid == null");
                    authconnecting = false;
                }
                else
                {
                    ...
                    {
                        MessageBox.Show("actualuniqueid == bdduniqueid");
                        authconnecting = true;
                    }
                    else
                    {
